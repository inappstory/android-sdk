...
import com.inappstory.sdk.packages.core.base.network.annotations.api.Body;
import com.inappstory.sdk.packages.core.base.network.annotations.api.DELETE;
import com.inappstory.sdk.packages.core.base.network.annotations.api.ExcludeHeaders;
import com.inappstory.sdk.packages.core.base.network.annotations.api.Field;
import com.inappstory.sdk.packages.core.base.network.annotations.api.FormUrlEncoded;
import com.inappstory.sdk.packages.core.base.network.annotations.api.GET;
import com.inappstory.sdk.packages.core.base.network.annotations.api.POST;
import com.inappstory.sdk.packages.core.base.network.annotations.api.PUT;
import com.inappstory.sdk.packages.core.base.network.annotations.api.Path;
import com.inappstory.sdk.packages.core.base.network.annotations.api.Query;
import com.inappstory.sdk.packages.core.base.network.annotations.api.QueryObject;
import com.inappstory.sdk.packages.core.base.network.annotations.api.ReplaceHeader;
import com.inappstory.sdk.packages.core.base.network.models.Request;
import com.inappstory.sdk.packages.core.base.network.utils.ObjectToQuery;
import com.inappstory.sdk.packages.core.base.network.utils.UrlEncoder;
import com.inappstory.sdk.packages.core.base.network.utils.headers.AcceptEncodingHeader;
import com.inappstory.sdk.packages.core.base.network.utils.headers.AcceptHeader;
import com.inappstory.sdk.packages.core.base.network.utils.headers.AcceptLanguageHeader;
import com.inappstory.sdk.packages.core.base.network.utils.headers.AuthSessionIdHeader;
import com.inappstory.sdk.packages.core.base.network.utils.headers.AuthorizationHeader;
import com.inappstory.sdk.packages.core.base.network.utils.headers.ContentTypeHeader;
import com.inappstory.sdk.packages.core.base.network.utils.headers.Header;
import com.inappstory.sdk.packages.core.base.network.utils.headers.HeadersKeys;
import com.inappstory.sdk.packages.core.base.network.utils.headers.MutableHeader;
import com.inappstory.sdk.packages.core.base.network.utils.headers.UserAgentHeader;
import com.inappstory.sdk.packages.core.base.network.utils.headers.XAppPackageIdHeader;
import com.inappstory.sdk.packages.core.base.network.utils.headers.XDeviceIdHeader;
import com.inappstory.sdk.packages.core.base.network.utils.headers.XRequestIdHeader;
import com.inappstory.sdk.packages.core.base.network.utils.headers.XUserIdHeader;
...
public final class NetworkHandler implements InvocationHandler {
    ...
    private Request generateRequest(
        ...
        Request request = builder
                ...
                .url(networkSettings.getHost() + path)
                .vars(vars)
                .varList(varList)
                .bodyRaw(bodyRaw)
    ...
    List<Header> generateHeaders(
        ...
        if (!excludeList.contains(HeadersKeys.ACCEPT_LANGUAGE))
            resHeaders.add(new AcceptLanguageHeader(networkSettings.getLanguageTag()));
        ...
        if (!excludeList.contains(HeadersKeys.APP_PACKAGE_ID))
            resHeaders.add(new XAppPackageIdHeader(networkSettings.getAppPackageId()));
        if (!excludeList.contains(HeadersKeys.AUTH_SESSION_ID))
            resHeaders.add(new AuthSessionIdHeader(networkSettings.getSessionId()));
        ...
        if (!excludeList.contains(HeadersKeys.DEVICE_ID) && hasDeviceId)
            resHeaders.add(new XDeviceIdHeader(networkSettings.getDeviceId()));
        ...
        if (!excludeList.contains(HeadersKeys.USER_AGENT))
            resHeaders.add(new UserAgentHeader(networkSettings.getUserAgent()));
        if (!excludeList.contains(HeadersKeys.USER_ID))
            resHeaders.add(new XUserIdHeader(networkSettings.getUserId()));
