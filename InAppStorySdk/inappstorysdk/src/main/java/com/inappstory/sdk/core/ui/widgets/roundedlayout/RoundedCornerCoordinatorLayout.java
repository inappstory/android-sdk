...
public class RoundedCornerCoordinatorLayout extends CoordinatorLayout {
    ...
    public RoundedCornerCoordinatorLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        setRadius(Sizes.dpToPxExt(16, context));
    }

    public RoundedCornerCoordinatorLayout(Context context, AttributeSet attrs, int defStyle) {
