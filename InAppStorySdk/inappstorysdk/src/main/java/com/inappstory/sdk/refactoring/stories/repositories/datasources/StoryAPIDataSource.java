...
public class StoryAPIDataSource implements IStoryAPIDataSource {
    ...
    public void getStoriesFeed(StoryFeedParameters feedParameters, ResultCallback<NFeed> storyFeedResultCallback) {
        ...
        core.connectionChecker().check(
                new SimpleConnectionCheckCallback() {
                    @Override
                    public void success() {
                    ...
                    protected void error() {
                        storyFeedResultCallback.invoke(new NoInternetError<>());
                    }
                }
        );
    ...
    public void getFavoriteStories(ResultCallback<List<NStory>> storyFeedResultCallback) {
        NetworkCallback<List<NStory>> callback = new NetworkCallback<List<NStory>>() {
            @Override
        ...
        core.connectionChecker().check(
                new SimpleConnectionCheckCallback() {
                    ...
                    @Override
                    protected void error() {
                        storyFeedResultCallback.error(new NoInternetError<>());
                    }
                }
        );
    ...
    public void likeStory(String storyId, boolean like, ResultCallback<Boolean> likeResultCallback) {
        core.connectionChecker().check(
                new SimpleConnectionCheckCallback() {
                    ...
                    public void success() {
                        core.network().enqueue(
                                ...
                                new NetworkCallback<Response>() {
                                    ...
                                    @Override
                                    public void error424(String message) {
                                        likeResultCallback.error(new Error424<>(message));
                                    }
                    ...
                    @Override
                    protected void error() {
                        likeResultCallback.error(new NoInternetError<>());
                    }
                }
        );
    ...
    public void dislikeStory(String storyId, boolean dislike, ResultCallback<Boolean> dislikeResultCallback) {
        core.connectionChecker().check(
                new SimpleConnectionCheckCallback() {
                    ...
                    public void success() {
                        core.network().enqueue(
                                ...
                                new NetworkCallback<Response>() {
                                    ...
                                    @Override
                                    public void error424(String message) {
                                        dislikeResultCallback.error(new Error424<>(message));
                                    }
                    ...
                    @Override
                    protected void error() {
                        dislikeResultCallback.error(new NoInternetError<>());
                    }
                }
        );
    ...
    public void favoriteStory(String storyId, boolean favorite, ResultCallback<Boolean> favoriteResultCallback) {
        core.connectionChecker().check(
                new SimpleConnectionCheckCallback() {
                    ...
                    public void success() {
                        core.network().enqueue(
                                ...
                                new NetworkCallback<Response>() {
                                    ...
                                    @Override
                                    public void error424(String message) {
                                        favoriteResultCallback.error(new Error424<>(message));
                                    }
                    ...
                    @Override
                    protected void error() {
                        favoriteResultCallback.error(new NoInternetError<>());
                    }
                }
        );
    ...
    public void removeAllFavorites(ResultCallback<Void> removeAllFavoritesCallback) {
        core.connectionChecker().check(
                new SimpleConnectionCheckCallback() {
                    ...
                    @Override
                    protected void error() {
                        removeAllFavoritesCallback.error(new NoInternetError<>());
                    }
                }
        );
    }
    ...
    public void getStoryBySlugOrId(
        ...
        core.connectionChecker().check(
                new SimpleConnectionCheckCallback() {
                    ...
                    public void success() {
                        core.network().enqueue(
                                ...
                                new NetworkCallback<NStory>() {
                                    ...
                                    @Override
                                    public void error424(String message) {
                                        storyResultCallback.error(new Error424<>(message));
                                    }
                                }
                        );
                    }
                    ...
                    @Override
                    protected void error() {
                        storyResultCallback.error(new NoInternetError<>());
                    }
                }
        );
