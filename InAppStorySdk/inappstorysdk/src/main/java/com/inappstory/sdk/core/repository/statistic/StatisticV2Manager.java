...
import com.inappstory.sdk.core.models.js.StatisticTask;
...
import com.inappstory.sdk.core.models.CurrentState;
...
public class StatisticV2Manager {
    private static StatisticV2Manager INSTANCE;
    ...
    public static StatisticV2Manager getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new StatisticV2Manager();
            INSTANCE.init();
        }
        return INSTANCE;
    }
    ...
    public void addFakeEvents(final int i,
        ...
        task2.cause = StatisticV2Manager.APPCLOSE;
        task2.slideIndex = si;
        task2.isFake = true;
        task2.slideTotal = st;
        task2.feedId = feedId;
